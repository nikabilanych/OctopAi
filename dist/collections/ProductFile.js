...
var ownedOrPurchased = function (_a) {
    var req = _a.req;
    return __awaiter(void 0, void 0, void 0, function () {
        var user, products, ownProductFileId, orders, purchasedProductFileId;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    ownProductFileId = products.map(function (product) { return product.product_files; }).flat();
                    return [4 /*yield*/, req.payload.find({
                            collection: "orders",
                            //user and id 
                ...
                case 2:
                    orders = (_b.sent()).docs;
                    purchasedProductFileId = orders.map(function (order) {
                    ...
                    return [2 /*return*/, {
                            ...
                            id: {
                                in: __spreadArray(__spreadArray([], ownProductFileId, true), purchasedProductFileId, true)
                            }
                        }];
            }
        });
