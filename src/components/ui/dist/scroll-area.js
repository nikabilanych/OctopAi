...
var ScrollArea = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(ScrollAreaPrimitive.Root, __assign({ ref: ref, className: utils_1.cn("relative overflow-hidden", className) }, props),
...
var ScrollBar = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(ScrollAreaPrimitive.ScrollAreaScrollbar, __assign({ ref: ref, orientation: orientation, className: utils_1.cn("flex touch-none select-none transition-colors", orientation === "vertical" &&
